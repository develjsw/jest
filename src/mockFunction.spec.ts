...
// 기본 테스트: obj.minus에 스파이를 심고 반환 값을 변경하지 않음
...
// test('obj.minus에 스파이를 심고 리턴값을 바꾸게 - Case1', () => {
...
// test('obj.minus에 스파이를 심고 리턴값을 바꾸게 - Case2', () => {
...
// test('obj.minus에 스파이를 심고 리턴값이 서로 다르게 나오게 - Case1', () => {
...
// test('obj.minus에 스파이를 심고 리턴값이 서로 다르게 나오게 - Case2', () => {
//     jest.spyOn(obj, 'minus')
//         .mockImplementationOnce((a, b) => a + b) // 첫 호출: 두 숫자를 더함
//         .mockImplementationOnce(() => 5) // 두 번째 호출: 5 반환
